Public Class FormFM1
    ...
    Private Sub FormFM1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub PictureBox3_Click(sender As Object, e As EventArgs) Handles PictureBox3.Click
        ...
        MessageBox.Show(Convert.ToString(LstSelectCust.Items(randomIndex)))
    End Sub

    Private Sub PictureBox4_Click(sender As Object, e As EventArgs) Handles PictureBox4.Click
        Dim rnd As New Random
        Dim randomIndex As Integer = rnd.Next(0, ComboBox1.Items.Count - 1)
        MessageBox.Show(Convert.ToString(ComboBox1.Items(randomIndex)))
    End Sub
